...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Sep 2022 pada 04.04
...
(4, 'Seksi Angkutan', 'Segera', 'Segera', '2022-09-30', 'Hadiri', 18, 1);
...
(1, 'PEMERINTAH KABUPATEN BANYUMAS', 'Dinas Perhubungan Kabupaten Banyumas', 'Telepon ( 0281 ) 637211 Fax. ( 0281 ) 637211', 'JL. Margantara, No. 460, Tanjung, Purwokerto Kode Pos 53134', 'AGUS NUR HADIE. M. Sos, M. Si.', '19690829 199001 1 002', 'http://dinhub.banyumaskab.go.id', 'dishub@gmail.com', 'departemen_perhubungan-logo-8fefd82495-seeklogocom4.png', 1);
...
(50, 'A', 'Pendidikan', 'Pendidikan Sekolah Menengah Kejuruan', 1),
(51, 'B', 'Sarana', 'Bangunan Sekolah dan Sarana Pendukung Lainnya', 1),
(52, 'C', 'Kurikulum', 'Kurikulum 2016', 1),
(53, 'D', 'Kegiatan', 'Ekstrakurikuler', 1),
(54, 'E', 'Administrasi', 'Administrasi Keuangan', 1);
...
(14, 4, '560/402.1/411.203/2016', 'Dinas Sosial Tenaga Kerja Dan Transmigrasi Daerah Kabupaten Nganjuk', 'Surat undangan untuk menghadiri acara Pameran Bursa Kerja Untuk Percepatan Penempatan Tenaga Kerja / Job Fair Tahun 2016', '421', 'A.2', '2016-05-12', '2016-07-24', '3058-document.pdf', 'Segera laksanakan', 1),
(17, 8452, '511.2/IX/2022', 'Dinas Perhubungan Kabupaten Banyumas', 'Surat Rekomendasi Angkutan Umum', 'R 10', 'Angkutan 2022', '2022-09-30', '2022-09-30', '', 'Segera laksanakan', 1),
(18, 5655, '511.2/5665/IX/2022', 'Purwokerto', 'dgegrtrhyryj', 'R 12', 'Angkutan 2022', '2022-09-29', '2022-09-30', '5848-1654-4002-1-PB.pdf', 'segera', 1);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'dq', '19103138', 1),
(2, 'disposisi', '13bb8b589473803f26a02e338f949b8c', 'Petugas Disposisi', '-', 3),
(3, 'irfandi', 'f5063ee3626f5281e4cc30670b60731d', 'Diki', '19103138', 2);
