                    ...
                    <div class="card blue-grey white-text">
                        <div class="card-content">';
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="ins">Dinas Perhubungan Kabupaten Banyumas</h5>';
                            }

                            if(!empty($data['alamat'])){
                                echo '<p class="almt">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="almt">JL. Margantara, No. 460, Tanjung, Purwokerto, Tanjung, Purwokerto Selatan, Banyumas Regency, Central Java 53144</p>';
                            }
                            echo '
                        </div>
                    </div>
