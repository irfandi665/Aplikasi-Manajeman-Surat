            ...
            <span class="white-text">&copy; <?php echo date("Y"); ?>
                <?php
                    if(!empty($data['nama'])){
                        ...
                        echo 'Dinas Perhubungan Kabupaten Banyumas  &nbsp;|&nbsp; <a class="white-text" href="http://masrud.com" target="_blank">dq</a>';
                    }
                ?>
            </a>
            </span>
            <div class="right hide-on-small-only">
                <?php
                    if(!empty($data['website'])){
                        ...
                        echo '<i class="material-icons md-12">public</i> www.dinhub.banyumaskab.go.id &nbsp;&nbsp;';
                    }
                    if(!empty($data['email'])){
                        echo '<i class="material-icons">mail_outline</i> '.$data['email'].'';
                    } else {
                        echo '<i class="material-icons">mail_outline</i>  dishub@gmail.com';
                    }
                }
                ?>
            </div>
