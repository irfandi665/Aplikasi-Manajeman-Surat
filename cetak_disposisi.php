<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        <div class="container">
            <div id="colres">
                <div class="disp">';
                    ...
                    if(!empty($institusi)){
                        ...
                        echo '<h6 class="up">PEMERINTAH KABUPATEN BANYUMAS</h6>';
                    }
                    if(!empty($nama)){
                        echo '<h5 class="up" id="nama">'.$nama.'</h5><br/>';
                    } else {
                        echo '<h5 class="up" id="nama">Dinas Perhubungan Kabupaten Banyumas</h5><br/>';
                    }
                    if(!empty($status)){
                        echo '<h6 class="status">'.$status.'</h6>';
                    } else {
                        echo '<h6 class="status">Telepon ( 0281 ) 637211 Fax. ( 0281 ) 637211</h6>';
                    }
                    if(!empty($alamat)){
                        echo '<span id="alamat">'.$alamat.'</span>';
                    } else {
                        echo '<span id="alamat">JL. Margantara, No. 460, Tanjung, Purwokerto Kode Pos 53134</span>';
                    }
                    echo '
                </div>
            ...
            <div id="lead">
                <p>Kepala Dinas Perhubungan Kabupaten Banyumas</p>
                <div style="height: 50px;"></div>';
